...
@Service
public class RedisRedPacketImpl implements RedisRedPacketService {
     ...
     * @return 抢红包插入数量.
     */
    public int executeBatch(List<UserRedPacket> userRedPacketList) throws SQLException {
